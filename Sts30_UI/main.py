...
from usr.sts30 import STS30  # Import STS30 temperature sensor driver
...
def initialize_system():  # Function to initialize or reinitialize the system
    ...
    sensor = STS30(i2c, address=0x4A)  # Initialize STS30 temperature sensor with I2C address 0x4A
...
while True:  # Infinite loop
    try:  # Main try block for error handling
        ...
        # Read Sensor - Get temperature data from STS30 sensor
        temp = sensor.get_temperature()  # Call sensor method to get temperature reading
        uart_print("STS30: Temperature: {} °C".format(temp))  # Format and send temperature data via UART
